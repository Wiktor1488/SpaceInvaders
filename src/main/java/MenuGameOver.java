...
/**
 * Klasa reprezentujaca menu po zakonczeniu gry.
 */
public class MenuGameOver {
    private SpriteBatch batch;  // Obiekt do renderowania menu
    private float buttonWidth = 200;  // Szerokosc przyciskow menu
    ...
    /**
     * Konstruktor menu po zakonczeniu gry.
     *
     * @param batch         Obiekt do renderowania menu
     * @param scoreManager  Manager wynikow
     */
    public MenuGameOver(SpriteBatch batch, ScoreManager scoreManager) {
        this.batch = batch;
    ...
    /**
     * Obsluguje interakcje uzytkownika na ekranie Game Over.
     */
    ...
    /**
     * Renderuje menu po zakonczeniu gry na ekranie.
     */
